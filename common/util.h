#ifndef PROGETTOSOL_UTIL_H
#define PROGETTOSOL_UTIL_H
...
#define SYSCALL_EXIT(cleanup, name, r, sc, str, ...)	    \
if ((r=sc) == -1) {				                            \
perror(#name);				                                \
...
#define CHECK_EQ_EXIT(cleanup, name, X, val, str, ...)	    \
if ((X)==val) {				                                \
perror(#name);				                                \
int errno_copy = errno;			                            \
print_error(str, __VA_ARGS__);                              \
...
#define CHECK_NEQ_EXIT(cleanup, name, X, val, str, ...)	    \
if ((X)!=val) {				                                \
perror(#name);				                                \
int errno_copy = errno;			                            \
print_error(str, __VA_ARGS__);		                        \
